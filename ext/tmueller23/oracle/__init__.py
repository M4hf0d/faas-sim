...
from srds import (
    ParameterizedDistribution as PDist,
...
class TMueller23FetOracle(FetOracle):
    ...
    def __init__(
        self, execution_times: Dict[Tuple[str, str], Tuple[float, float, PDist]]
    ):
        super().__init__()
...
class TMueller23ResourceOracle(ResourceOracle):
    ...
    def __init__(
        self, resources: Dict[Tuple[str, str], "FunctionResourceCharacterization"]
    ):
        super().__init__()
